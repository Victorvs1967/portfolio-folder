...
import com.vvs.fullregistrationwithmail.model.UserRole;
import com.vvs.fullregistrationwithmail.validator.EmailValidator;
...
public class RegistrationService {
  ...
  public String confirmedToken(String token) {
    ...
    if (confirmationToken.getConfirmedAt() != null) {
      ...
      return "<h3>email already confirmed<h3>";
    }
    ...
    if (expiredAt.isBefore(LocalDateTime.now())) {
      ...
      return "<h2>email already confirmed<h2>";
    }

    confirmationTokenService.setConfirmedAt(token);
    userService.enableUser(confirmationToken.getUser().getEmail());

    return "<h3 style=\"font-family:Helvetica,Arial,sans-serif;\">Your email confirmed</h3><h1>Welcome!</h1>";
  }
